...
const WhatsAppIcon = ({ size = 24 }: { size?: number }) => (
  ...
  >
    <g id="SVGRepo_bgCarrier" strokeWidth="0" transform="translate(0,0), scale(1)">
      <rect x="-126.28" y="-126.28" width="560.56" height="560.56" rx="280.28" fill="#118f2c" strokeWidth="0"></rect>
    </g>
    ...
    <div className="fixed bottom-4 right-4 md:bottom-8 md:right-8 z-50 flex flex-col items-end">
      ...
      {isExpanded && (
        <div className="mb-4 bg-white rounded-[20px] shadow-xl overflow-hidden w-[300px] md:w-[320px] max-w-[calc(100vw-32px)]">
          {/* Header */}
          <div className="bg-[#118f2c] px-4 py-3.5 flex items-center justify-between relative">
          ...
          <div className="p-4 bg-[#f0f2f5]">
            {showTyping && (
              <div className="bg-[#118f2c] text-white px-4 py-3 rounded-[15px] inline-block max-w-[85%]">
            ...
            {showMessage && (
              <>
                <div className="bg-[#118f2c] text-white px-4 py-3 rounded-[15px] inline-block max-w-[85%] text-[14px] leading-[1.4]">
          ...
          <button
            ...
            className="w-full bg-[#118f2c] text-white py-3.5 flex items-center justify-center gap-3 hover:bg-[#118f2c] transition-colors text-[15px] font-medium"
          >
      ...
      <button
        ...
        className="w-[60px] h-[60px] rounded-full bg-[#118f2c] shadow-xl flex items-center justify-center hover:bg-[#118f2c] transition-colors relative"
