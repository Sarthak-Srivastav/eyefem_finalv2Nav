        ...
        <header className="bg-white shadow-sm fixed top-0 left-0 right-0 z-50">
          <div className="container mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              <Link to="/gynocelogy/doctor" className="text-gray-800 hover:text-primary transition-colors">Dr. Nisha Bhatnagar</Link>
            </div>
          </div>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden bg-white shadow-md py-4 px-6 absolute w-full">
              <nav className="flex flex-col space-y-4">
                ...
                <Link to="/gynecology/doctor" className="text-gray-800 hover:text-primary transition-colors py-2" onClick={closeMobileMenu}>
                  Dr. Nisha Bhatnagar
                </Link>
              </nav>
            </div>
